      ...
      <main id="top" className="relative z-10">
        ...
        <section className="mx-auto flex max-w-6xl flex-col items-center px-6 pt-10 pb-20 text-center sm:pt-14">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            <a
              href={DISCORD_INVITE}
              className="rounded-md bg-primary px-7 py-3 font-mono text-sm font-semibold tracking-widest text-primary-foreground uppercase transition-all hover:shadow-[0_0_30px_oklch(0.48_0.19_25/55%)]"
            >
              Join the Crew
            </a>
            <Link
          ...
          <div className="surface-plate rounded-2xl border border-border px-8 py-12">
            <div className="flex flex-col items-center gap-8 text-center lg:flex-row lg:justify-between lg:text-left">
              <div>
                ...
                <Link
                  to="/roster"
                  className="mt-6 inline-block rounded-md border border-steel/40 bg-secondary/40 px-6 py-2.5 font-mono text-xs font-semibold tracking-widest text-foreground uppercase transition-colors hover:border-gold/50 hover:text-gold"
                >
                  Open the Roster
                </Link>
              </div>
        ...
        <section id="join" className="mx-auto max-w-6xl scroll-mt-24 px-6 pb-24">
          <div className="surface-plate relative overflow-hidden rounded-2xl border border-ichor/30 px-8 py-14 text-center">
            ...
            <div className="relative">
              ...
              <a
                href={DISCORD_INVITE}
                className="mt-8 inline-block rounded-md bg-primary px-8 py-3 font-mono text-sm font-semibold tracking-widest text-primary-foreground uppercase transition-all hover:shadow-[0_0_30px_oklch(0.48_0.19_25/50%)]"
              >
                Enter the Discord
              </a>
